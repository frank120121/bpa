...
async def handle_anti_fraud(buyer_name, seller_name, conn, anti_fraud_stage, response, order_no, connection_manager, account, payment_manager, binance_api):
    questions = [
    ...
    if anti_fraud_stage == 3:
        ...
        if similarity >= 95:
            ...
            await connection_manager.send_text_message(account, f"No pudimos verificar el banco proporcionado. Por favor, asegúrese de elegir uno de los siguientes bancos aceptados: {accepted_banks_list}", order_no)
